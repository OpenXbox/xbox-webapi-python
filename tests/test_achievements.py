...
async def test_achievement_360_all(aresponses, xbl_client):
    aresponses.add("achievements.xboxlive.com", response=get_response("achievements_360_all"))
    
    ret = await xbl_client.achievements.\
...
async def test_achievement_360_earned(aresponses, xbl_client):
    aresponses.add("achievements.xboxlive.com", response=get_response("achievements_360_earned"))
...
async def test_achievement_360_recent_progress(aresponses, xbl_client):
    aresponses.add("achievements.xboxlive.com", response=get_response("achievements_360_recent_progress"))
...
async def test_achievement_one_details(aresponses, xbl_client):
    aresponses.add("achievements.xboxlive.com", response=get_response("achievements_one_details"))
...
async def test_achievement_one_gameprogress(aresponses, xbl_client):
    aresponses.add("achievements.xboxlive.com", response=get_response("achievements_one_gameprogress"))
...
async def test_achievement_one_recent_progress(aresponses, xbl_client):
    aresponses.add("achievements.xboxlive.com", response=get_response("achievements_one_recent_progress"))
