...
async def test_channel_list_download(respx_mock, xbl_client):
    route = respx_mock.get("https://cqs.xboxlive.com").mock(return_value=Response(200, json=get_response_json("cqs_get_channel_list")))
...
async def test_schedule_download(respx_mock, xbl_client):
    route = respx_mock.get("https://cqs.xboxlive.com").mock(return_value=Response(200, json=get_response_json("cqs_get_schedule")))
