...
async def test_userstats_by_scid(respx_mock, xbl_client):
    route = respx_mock.get("https://userstats.xboxlive.com").mock(return_value=Response(200, json=get_response_json("userstats_by_scid")))
...
async def test_userstats_by_scid_with_metadata(respx_mock, xbl_client):
    route = respx_mock.get("https://userstats.xboxlive.com").mock(return_value=Response(200, json=get_response_json("userstats_by_scid_with_metadata")))
...
async def test_userstats_batch(respx_mock, xbl_client):
    route = respx_mock.post("https://userstats.xboxlive.com").mock(return_value=Response(200, json=get_response_json("userstats_batch")))
...
async def test_userstats_batch_by_scid(respx_mock, xbl_client):
    route = respx_mock.post("https://userstats.xboxlive.com").mock(return_value=Response(200, json=get_response_json("userstats_batch_by_scid")))
