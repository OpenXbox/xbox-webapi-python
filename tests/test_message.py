...
async def test_get_inbox(respx_mock, xbl_client):
    route = respx_mock.get("https://xblmessaging.xboxlive.com").mock(return_value=Response(200, json=get_response_json("message_get_inbox")))
...
async def test_get_conversation(respx_mock, xbl_client):
    route = respx_mock.get("https://xblmessaging.xboxlive.com").mock(return_value=Response(200, json=get_response_json("message_get_conversation")))
...
async def test_get_new_conversation(respx_mock, xbl_client):
    route = respx_mock.get("https://xblmessaging.xboxlive.com").mock(return_value=Response(200, json=get_response_json("message_new_conversation")))
    ret = await xbl_client.message.get_conversation(
        "05907fa3-0000-0009-acbd-299772a90900"
    )
...
async def test_delete_conversation(respx_mock, xbl_client):
    route = respx_mock.put("https://xblmessaging.xboxlive.com").mock(return_value=Response(200))
...
async def test_delete_message(respx_mock, xbl_client):
    route = respx_mock.delete("https://xblmessaging.xboxlive.com").mock(return_value=Response(200))
...
async def test_send_message(respx_mock, xbl_client):
    route = respx_mock.post("https://xblmessaging.xboxlive.com").mock(return_value=Response(200, json=get_response_json("message_send_message")))
